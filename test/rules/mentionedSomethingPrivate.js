...
var rule = require('../../rules/mentionedSomethingPrivate.js');

var githubPing = {
  zen: 'test'
};

var mentionedSomethingPrivateIsFalsePositive = {
  "action": "created",
  "issue": {
    ...
    "closed_at": null,
    "body": "It looks like you accidently spelled 'commit' with two 't's. pk.fjfkd"
  },
  "comment": {
    ...
    "created_at": "2015-05-05T23:40:28Z",
    "updated_at": "2015-05-05T23:40:28Z",
    "body": "You are totally right! I'll get this fixed right away. sk.foobar"
  },
  "repository": {
    "id": 35129377,
    "name": "public-repo",
...
var mentionedSomethingPrivateIsTrue = {
  "action": "created",
  "issue": {
    "url": "https://api.github.com/repos/baxterthehacker/public-repo/issues/2",
    "labels_url": "https://api.github.com/repos/baxterthehacker/public-repo/issues/2/labels{/name}",
  ...
  "comment": {
    ...
    "created_at": "2015-05-05T23:40:28Z",
    "updated_at": "2015-05-05T23:40:28Z",
    "body": "You are totally right! I'll get this fixed right away. sk.eyJ1IjoidG1jdyIsImEiOiJjaXBnNTF6c20wMDBudGxtZHg2amRxbXlxIn0.0lAVKpQpR70wqK1sKdZ03g"
  },
  "repository": {
    "id": 35129377,
    "name": "public-repo",
...
test('Someone mentions something private', function(t) {
  rule.fn(mentionedSomethingPrivateIsTrue, function(err, message) {
    t.ifError(err);
    t.equal(message.subject, 'baxterthehacker mentioned a private token on public-repo', 'subject');
    t.equal(message.summary, 'baxterthehacker at https://github.com/baxterthehacker/public-repo/issues/2#issuecomment-99262140 mentioned a private token on public-repo', 'summary');
    t.end();
  });
});

test('Potential false-positive of pk started string', function(t) {
  rule.fn(mentionedSomethingPrivateIsFalsePositive, function(err, message) {
    t.ifError(err);
    t.equal(message, 'A safe comment was posted');
    t.end();
  });
});
